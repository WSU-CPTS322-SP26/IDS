/*
 * Parses and interprets packets, with the help of filtering functions
 * and prints a summary of the UDP traffic on a network. Summary includes
 * time, length of packet, and source IP + destination UDP port.
